...
const Sign_up = () => {
  ...
  const handleCreate = async () => {
    ...
    if(await postCreateUser(User_ID,password)===201){
      //登録成功
      ...
      elm.style.display = '';
      elm.textContent="※問題が発生し登録できませんでした。IDを変更して試行してください";
    }
  }else{
    //エディットバリデーションミス
    var elm = document.getElementById("400code");
  ...
  return (
    ...
    <form method="POST">
      ...
      ><span id="400code"  style={{display:"none"}}>※問題が発生し登録できませんでした。IDを変更して試行してください</span></Typography>
